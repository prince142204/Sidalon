...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Floating Squares for Futuristic Effect */
        .shape {
            position: absolute;
            background: rgba(255, 255, 255, 0.6);
            animation: float 8s infinite; /* Faster animation */
            opacity: 0.1;
            border-radius: 10%; /* Adding a bit of roundness */
        }

        /* Adjusting shape sizes and positions */
        .shape-1 {
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div>
                <input type="text" name="username" required placeholder="Enter your username" value="{{ old('username') }}">
            </div>
            <div>
